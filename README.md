...
Returns aggregate totals overall and grouped by model:
...
```
GET /savings/history?limit=50&offset=0
```

Returns a paginated raw log sorted by newest first (`limit` max 500):
...
│   └── savings.ts        # GET /savings/summary, /savings/history
└── lib/
